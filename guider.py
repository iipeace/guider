...
class FunctionInfo:
    ...
    def printUsage(self):
            ...
            # Print cpu usage in kernelspace #
            SystemInfo.clearPrint()
           ...
           # Print mem usage in kernelspace #
            SystemInfo.clearPrint()
