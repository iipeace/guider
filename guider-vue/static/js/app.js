...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/SocketIO.vue
//
//
//
//
...
/* harmony default export */ var SocketIO = ({
  name: 'socket-io',
  data: function data() {
    return {
      clientMsg: '',
  ...
  sockets: {
    ...
    server_response: function server_response(msg) {
      // msg is json
    ...
    request_stop_result: function request_stop_result(msg) {
      this.appendLog(msg);
    }
  },
  methods: {
    ...
    emitStop: function emitStop() {
      console.log('Stop button Clicked!');
      this.$socket.emit('request_stop', this.targetTimestamp);
    },
    appendLog: function appendLog(newLog) {
      this.log += newLog + '\n';
    },
    ...
    refineCpuPipe: function refineCpuPipe(pipe) {
      var jsonObj = JSON.parse(pipe);
      var cpuTotal = [];
      var jsonPercore = jsonObj.percore;
      var logCpu = 'Emit Count <' + String(this.emitCount) + '>    :  ';
      for (var i = 0; i < jsonObj.nrCore; i++) {
    ...
    refineMemPipe: function refineMemPipe(pipe) {
      var jsonObj = JSON.parse(pipe);
      var memTotal = {};
    ...
    refineProcPipe: function refineProcPipe(pipe) {
      var jsonObj = JSON.parse(pipe);
      var procTotal = []; // Json Array to return

      for (var keyPID in jsonObj) {
        // key is PID.
        var objPID = {};
        objPID['PID'] = keyPID;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-51ac903a","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/SocketIO.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',[_c('font',{attrs:{"size":"2"}},[_vm._v("Input the guider target IP addr and port (ex> 192.168.24.12:5000) ")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.targetAddr),expression:"targetAddr"}],attrs:{"type":"text"},domProps:{"value":(_vm.targetAddr)},on:{"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.emitStart($event)},"input":function($event){if($event.target.composing){ return; }_vm.targetAddr=$event.target.value}}}),_vm._v(" "),_c('button',{staticClass:"basic-button",attrs:{"id":"emitStart"},on:{"click":_vm.emitStart}},[_vm._v("Start")]),_vm._v(" "),_c('button',{staticClass:"basic-button",attrs:{"id":"disconnectSocket"},on:{"click":_vm.disconnectSocket}},[_vm._v("Stop")])],1)])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var components_SocketIO = (esExports);
// CONCATENATED MODULE: ./src/components/SocketIO.vue
...
/* harmony default export */ var src_components_SocketIO = (Component.exports);
...
/* harmony default export */ var App = ({
  name: 'App',
  components: { SocketIo: src_components_SocketIO },
  data: function data() {
    return {
      ...
      procChartOptions: {},
      memChartOptions: {},
      colorCodes: ['#DC143C', '#008000', '#000080', '#b07025', '#FFFF00', '#BFFF00', '#80FF00', '#40FF00', '#00FF00', '#00FF40', '#00FF80', '#00FFBF', '#00FFFF', '#00BFFF', '#0080FF', '#0040FF']
    };
  },
  ...
  mounted: function mounted() {
    ...
    // this.initChart();
    EventBus.$on('reset_data', function (nothing) {
      _this.cpuUsage = [];
      _this.memUsageTypeA = {};
      _this.memUsageTypeB = {};
      _this.procInfo = [];
    ...
    EventBus.$on('cnt_emit', function (cpuEmit) {
      _this.emitCount = _this.emitCount + 1;
    });
    EventBus.$on('cpu_usage', function (cpuTotal) {
      if (_this.emitCount === 1) {
        // linechartArrSize = this.arrSize;
        _this.cpuUsage = new Array(cpuTotal.length);
        for (var i = 0; i < cpuTotal.length; i++) {
          _this.cpuUsage[i] = new Array(_this.arrSize);
          for (var j = 0; j < _this.arrSize; j++) {
            _this.cpuUsage[i][j] = undefined;
          }
        }
      }
      for (var _i = 0; _i < cpuTotal.length; _i++) {
        _this.cpuUsage[_i].shift();
        _this.cpuUsage[_i].push(cpuTotal[_i]);
      }
      _this.flagCpuEmit++;
    });
    EventBus.$on('mem_usage', function (memTotal) {
      // in this event handler, mem usage data is divided into two groups A(total/available) / B(the others)
      _this.memUsage = memTotal;
      var memUsageAll = JSON.parse(stringify_default()(_this.memUsage));
      ...
      memUsageTypeA['used'] = _this.memUsage['total'] - memUsageTypeA['available'];
      delete memUsageTypeA['total'];

      _this.memUsageTypeA = memUsageTypeA;
      _this.memUsageTypeB = memUsageTypeB;
    });
    EventBus.$on('proc_usage', function (procTotal) {
      _this.procInfo = procTotal;
    });
  }
});
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-cb39c66c","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/App.vue
var App_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('socket-io'),_vm._v(" "),_c('input',{attrs:{"type":"hidden","id":"serverAddr","value":"%% server_addr %%"}})],1)}
var App_staticRenderFns = []
var App_esExports = { render: App_render, staticRenderFns: App_staticRenderFns }
/* harmony default export */ var selectortype_template_index_0_src_App = (App_esExports);
// CONCATENATED MODULE: ./src/App.vue
function injectStyle (ssrContext) {
  __webpack_require__("g4zG")
}
...
var vue_socketio = __webpack_require__("HI0L");
...
var serverAddr =  false ? 'http://localhost:5000' : document.getElementById('serverAddr').value;

vue_esm["a" /* default */].use(new vue_socketio_default.a({
  debug: true,
  connection: serverAddr // 'http://localhost:5000'
}));

var vm = new vue_esm["a" /* default */]({
...
// load the styles
var content = __webpack_require__("2EBy");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("63e162d0", content, true, {});
